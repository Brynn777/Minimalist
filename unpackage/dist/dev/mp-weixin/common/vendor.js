...
/***/ 107:
/*!******************************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/components/uni-icons/icons.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!***************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/store/index.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: {
    ...
    // 添加一个一般页面缓存
    changePPTContent: function changePPTContent(state, data) {
      _vue.default.set(state.PPT, data.index, data.content);
    },
    addContentPage: function addContentPage(state, data) {
      state.PPT.splice(data.index, 0, {
        pageType: data.pageType });

    },
    // 在填写目录页后调用,将本次的目录分成多个过渡页逐一缓存
    addTransitionPage: function addTransitionPage(state, data) {
      // 清除之前的目录(过渡页)
      for (var i = state.PPT.length - 1; i >= 0; i--) {
...
/***/ 17:
/*!****************************************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/js_sdk/zhouWei-request/requestConfig.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 18:
/*!**********************************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/js_sdk/zhouWei-request/request.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var qiniuUploader = __webpack_require__(/*! ./qiniuUploader */ 19);var
request = /*#__PURE__*/function () {
  // request对象的默认baseurl headers 和options在new$http的时候决定
  ...
  _createClass(request, [{ key: "getDefault", value: function getDefault(url, options, type) {
      ...
      // requeset对象的options是覆盖默认配置(这里用一个空对象是为了不改变默认的this.config)
      // {
      // 	isPrompt: 覆盖
      // 	load: 覆盖
      // 	isFactory: 覆盖
      ...
      //请求头
      // requeset对象的headers是在原来的header上保留并且覆盖
      // {
      // 	isPrompt: 覆盖
      // 	load: 覆盖
      // 	isFactory: 覆盖
      ...
      // 为了修改request对象的默认headers和options
      return config;
    }
      ...
      return new Promise(function (resolve, reject) {
        _this3.getRequest("GET", requestInfo, function (state, response) {
          ...
          if (state && requestInfo.isFactory && _this3.dataFactory) {
            //数据处理
            _this3.dataFactory(_objectSpread({},
            requestInfo, {
              response: response,
              resolve: resolve,
              reject: reject }));
      ...
      return new Promise(function (resolve, reject) {
        _this4.getRequest("PUT", requestInfo, function (state, response) {
          ...
          if (state && requestInfo.isFactory && _this4.dataFactory) {
            //数据处理
            _this4.dataFactory(_objectSpread({},
            requestInfo, {
              response: response,
              resolve: resolve,
              reject: reject }));
      ...
      return new Promise(function (resolve, reject) {
        _this5.getRequest("DELETE", requestInfo, function (state, response) {
          ...
          if (state && requestInfo.isFactory && _this5.dataFactory) {
            //数据处理
            _this5.dataFactory(_objectSpread({},
            requestInfo, {
              response: response,
              resolve: resolve,
              reject: reject }));
    ...
    //七牛云文件上传（支持多张上传）
      ...
      return new Promise(function (resolve, reject) {
        if (typeof files == "object") {
          ...
          _this.get("api/kemean/aid/qn_upload").then(function (data) {
            /*
                                                                      *接口返回参数：
                                                                      *visitPrefix:访问文件的域名
                                                                         *token:七牛云上传token
...
/***/ 19:
/*!****************************************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/js_sdk/zhouWei-request/qiniuUploader.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 26:
/*!***************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/utils/utils.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var DATA = {
  baseUrl: baseUrl, url: url };exports.DATA = DATA;
...
function movePPT(id, from, to) {
  return _requestConfig.default.post(url.MOVE, {
    fileId: id,
    formPageNum: from,
    toPageNum: to });
...
/***/ 4:
/*!***********************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/pages.json ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 62:
/*!*********************************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/pages/TextInput/input/content.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!****************************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/pages.json?{"type":"style"} ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/tabbar/tabbar-1/tabbar-1": { "navigationStyle": "custom", "usingComponents": { "uni-fab": "/components/uni-fab/uni-fab", "uni-nav-bar": "/components/uni-nav-bar/uni-nav-bar" }, "usingAutoImportComponents": {} }, "pages/tabbar/tabbar-2/tabbar-2": { "usingComponents": { "uni-icons": "/components/uni-icons/uni-icons", "uni-steps": "/components/uni-steps/uni-steps" }, "usingAutoImportComponents": {} }, "pages/tabbar/tabbar-3/tabbar-3": { "navigationBarTitleText": "个人中心", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/TextInput/selectPage/selectPage": { "usingComponents": { "uni-steps": "/components/uni-steps/uni-steps", "uni-list": "/components/uni-list/uni-list", "uni-list-item": "/components/uni-list-item/uni-list-item", "uni-icons": "/components/uni-icons/uni-icons" }, "usingAutoImportComponents": {} }, "pages/TextInput/input/input": { "usingComponents": { "uni-steps": "/components/uni-steps/uni-steps", "uni-icons": "/components/uni-icons/uni-icons", "sun-ui-upimg": "/components/sunui-upimg/sunui-upimg" }, "usingAutoImportComponents": {} }, "pages/TextInput/previewPPT/previewPPT": { "usingComponents": { "uni-steps": "/components/uni-steps/uni-steps" }, "usingAutoImportComponents": {} }, "pages/center/center": { "usingComponents": { "uni-list": "/components/uni-list/uni-list", "uni-list-item": "/components/uni-list-item/uni-list-item", "uni-icons": "/components/uni-icons/uni-icons" }, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "极简主义", "navigationBarBackgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!***************************************************************************!*\
  !*** C:/Users/Brynn/Desktop/极简主义-一键生成PPT/极简主义/pages.json?{"type":"stat"} ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
